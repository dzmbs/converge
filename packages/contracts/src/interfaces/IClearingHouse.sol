...
/// @notice A clearing house (e.g. SKY, Infiniti) that fronts liquidity for non-atomic RWA redemptions.
///         When the pool lacks redeemAsset to service a swap, the clearing house provides it instantly
///         and takes the IOU (redemption receipt) in return, earning yield for the duration risk.
interface IClearingHouse {
    ...
    ///         and receives `rwaAmount` of rwaToken as collateral (the IOU).
